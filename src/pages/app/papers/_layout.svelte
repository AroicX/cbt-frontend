<script>
  ...
  import AddPaper from "../../../components/papers/add-paper.svelte";
  ...
  <div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
      <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">Manage Papers</h3>
          ...
          <div class="toggle-expand-content" data-content="pageMenu">
            <ul class="nk-block-tools g-3">
              ...
              <li class="nk-block-tools-opt"><a href={`#`} class="btn btn-primary" data-toggle="collapse"
                  data-target="#accordion-item-1"><em class="icon ni ni-reports"></em><span>Add Paper</span></a>
              </li>
            </ul>
          </div>
        </div>
