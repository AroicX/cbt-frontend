        ...
        <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
          <thead>
            <tr class="nk-tb-item nk-tb-head">
              ...
              <th class="nk-tb-col tb-col-lg"><span class="sub-text">Paper Name</span></th>
          ...
          <tbody>
            ...
            <tr class="nk-tb-item">
              ...
              <!-- <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                <span class="tb-amount">002291 </span>
              </td> -->
          
              <td class="nk-tb-col tb-col-lg" data-order="Email Verified - Kyc Unverified">
                <ul class="list-status">
                  <li><em class="icon text-success ni ni-check-circle"></em> <span>{paper.name}</span></li>
                </ul>
              </td>
              <td class="nk-tb-col tb-col-lg">
                <span>{formatDateString(paper.created_at)}</span>
              </td>
                    ...
                    <div class="drodown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <ul class="link-list-opt no-bdr">
                          ...
                          <li><a href={`/app/papers/edit/${paper.id}`}><em class="icon ni ni-repeat"></em><span>Edit</span></a></li>
